                            ...
                            child: Column(
                              children: [
                                ...
                                CustomTextField.customFormTextField(
                                  ...
                                  prefix: const Icon(Icons.lock_outline_rounded, color: kPrimaryColor),
                                ),
                                const SizedBox(
                                  height: 30,
                                ),
                                CustomButton(
                                  onTap: () async {
                                    if (formKey.currentState!.validate()) {
                                      ...
                                      try {
                                        http.Response response = await http.post(Uri.parse(signInApi), body: {
                                          'username': userName,
                                          'password': passWord,
                                        });
                                        if (response.statusCode == 200) {
                                          ...
                                          if (data['status'] == 'false') {
                                            ...
                                            Navigator.pushReplacementNamed(context, 'NavBar', arguments: user);
                                            setState(() {
                                              isLoading = false;
                                            });
                                          }
